...
* The original package name 'com.practice.sample-maven-mongo-application' is invalid and this project uses 'com.practice.samplemavenmongoapplication' instead.
